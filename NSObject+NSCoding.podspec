...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/NSObject+NSCoding"
  ...
  # Or just: s.author    = "Ravi Prakash Sahu"
  # s.authors            = { "Ravi Prakash Sahu" => "emailatravi@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Ravi Prakash Sahu"
  ...
  s.source       = { :git => "http://EXAMPLE/NSObject+NSCoding.git", :tag => "0.0.1" }
